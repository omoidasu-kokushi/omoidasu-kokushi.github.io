...
const CACHE_NAME = 'v3.17.0';   /* V2.12からアプリ版と揃える（v1.99の次を v1.100 にしない） */
...
const OPTIONAL_ASSETS = [
  ...
  './questions_free_mock.js?v=3.17',
  './images/bessatsu/111_am81.png',
  './images/bessatsu/113_am23.png',
  './images/bessatsu/114_am13.png',
  './images/bessatsu/114_am107.png',
  /* 選択肢が図の問題（V2.66）。本体の問題PDFから切り出した線画のみ。 */
  './images/sentakushi/112_am57.png',
  './images/sentakushi/113_am110.png',
  './images/sentakushi/113_am46.png',
  './images/sentakushi/113_pm21.png',
  './images/sentakushi/113_pm37.png',
  './images/sentakushi/113_pm54.png',
