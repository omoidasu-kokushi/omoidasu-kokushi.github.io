...
ok("CACHE_NAME を上げた", mv and mv.group(1) == "3.21.0", mv.group(1) if mv else None)
ok("?v= を揃えた", "?v=3.21" in html and "?v=3.20" not in html)
ok("build-stamp を上げた", "20260915_Omoidasu_V3.21" in html)
