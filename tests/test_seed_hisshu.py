...
ok("CACHE_NAME を上げた", mv and mv.group(1) == "2.95.0", mv.group(1) if mv else None)
ok("?v= を揃えた", "?v=2.95" in html and "?v=2.94" not in html)
ok("build-stamp を上げた", "20260910_Omoidasu_V2.95" in html)
