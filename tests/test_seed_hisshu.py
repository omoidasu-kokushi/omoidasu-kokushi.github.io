...
ok("CACHE_NAME を上げた", mv and mv.group(1) == "3.22.0", mv.group(1) if mv else None)
ok("?v= を揃えた", "?v=3.22" in html and "?v=3.21" not in html)
ok("build-stamp を上げた", "20260916_Omoidasu_V3.22" in html)
